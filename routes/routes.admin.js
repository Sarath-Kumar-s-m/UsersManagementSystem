...
adminRoutes.post('/admin/dashboard/api/v1/createuser',adminAuthentication.adminDashBoardAuthentication, adminControllers.createUser);
...
// adminRoutes.post('/admin/dashboard/api/v1/updateuser',adminAuthentication.adminDashBoardAuthentication, adminControllers.updateUser);
